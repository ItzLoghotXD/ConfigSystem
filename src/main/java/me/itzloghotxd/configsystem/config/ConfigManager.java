package me.itzloghotxd.configsystem.config;

import me.itzloghotxd.configsystem.ConfigSystem;
...
public class ConfigManager {
     ...
     */
    public void loadFiles(ConfigSystem plugin) {
        ...
        // You can add more configuration files
    ...
    public FileConfiguration getConfig(ConfigType type) {
        return ConfigSystem.getPlugin().getConfigManager().getFile(type).getConfig(); // Get and return the configuration for the specified type
    }
